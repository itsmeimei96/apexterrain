        ...
        htmlBody: `
          <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#fff;">
            ...
            <div style="padding:40px;">
              ...
              <p style="color:#444;line-height:1.7;margin:0 0 32px;">In the meantime, if you have any urgent questions, please feel free to call us directly at <strong>236-662-8066</strong>. Our team is available 7 days a week from 7:00 AM to 7:00 PM.</p>
            ...
            <div style="background:#f5f5f5;padding:20px 40px;text-align:center;border-top:1px solid #eee;">
              <p style="color:#999;font-size:12px;margin:0;">Mission, BC &nbsp;·&nbsp; 236-662-8066 &nbsp;·&nbsp; apexterrain.ca</p>
            </div>
          </div>
        `
      });
